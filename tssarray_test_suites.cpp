           ...
           "[types]" )
{
    ...
    SECTION( "Member function move= - return type" )
    {
        ...
        TSSArray<string> ts2;
        TSSArray<string> ts3;
        TSSArray<string> & r(ts1 = move(ts2));
