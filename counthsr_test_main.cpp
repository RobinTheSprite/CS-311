...
// Requires counthsr_test_suites.cpp, catch.hpp, counthsr.h, counthsr.cpp
...
int main(int argc, char *argv[])
{
    ...
    {
        // Run test suites
        std::cout << "BEGIN tests for function countHSR"
                  << " - CS 311 Assn 4, Ex A"
                  << std::endl
                  << std::endl;
        catchresult = session.run();
        std::cout << "END tests for function countHSR"
                  << " - CS 311 Assn 4, Ex A"
                  << std::endl
                  << std::endl;
    }
